    ...
    ${
      ...
      >
        {!showConfirm ? (
          ...
          <div
            className={`transition-all duration-200 ease-in-out ${isClosing || !isVisible ? "opacity-0 translate-y-4" : "opacity-100 translate-y-0"}`}
          >
            <div className="flex mb-2 justify-between items-center">
              <p className="text-xl font-bold">Potvrdi izmjene</p>
            </div>
            <p className="text-sm text-gray-500">
              Unesi trenutnu lozinku da potvrdiš izmjene.
            </p>
