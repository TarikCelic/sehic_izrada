...
const MessageInfo = ({ poruka, onClose }: { poruka: any, onClose: () => void }) => {
            ...
            <div className={`relative bg-white w-full max-w-2xl max-h-[90vh] overflow-hidden rounded-2xl shadow-2xl flex flex-col transition-all duration-200 ease-in-out
                ...
                <div className="flex items-center justify-between p-6 border-b border-zinc-100 bg-white">
                    <div>
                        ...
                        <p className="text-xs text-zinc-400 font-mono mt-1">ID: {poruka.id}</p>
                    </div>
                    <button
                        onClick={handleClose}
                ...
                <div className="p-6 overflow-y-auto bg-white">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest border-b pb-1">Pošiljalac</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest border-b pb-1">Datum</h3>
                        ...
                        <div className="col-span-full space-y-2">
                            <h3 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest border-b pb-1">Poruka</h3>
