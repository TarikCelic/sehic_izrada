        ...
        <div className="mt-16 flex min-h-[calc(100vh-4rem)] justify-center items-center px-4 py-8">
            <div className="w-full max-w-sm flex flex-col gap-2 justify-center items-center rounded-xl shadow-md px-6 py-8 animate-fade-down bg-white">
                <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-sm text-gray-500 text-center mt-1">Unesite svoje podatke kako bi nastavili.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="flex flex-col items-center gap-3 pt-4 w-full">
                    <input
                        value={email}
                        type="email"
                        placeholder="E-Mail"
                ...
                <p className="text-sm text-gray-500 mt-1">
                    ...
                    <Link className="text-(--primary) underline" href="/register">Registrujte se</Link>
                </p>
            </div>
        </div>
    )
