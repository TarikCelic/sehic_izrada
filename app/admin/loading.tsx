    ...
    <section className="flex flex-col gap-8 p-4 sm:p-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="flex flex-col gap-3 bg-black/5 px-4 py-6 rounded-sm border-l-4 border-gray-200"
          >
      ...
      <div className="flex flex-col w-full rounded-2xl overflow-hidden border border-gray-100">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="flex items-center w-full px-4 py-4 border-b border-gray-100"
          >
