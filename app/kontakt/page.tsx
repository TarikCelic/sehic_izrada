            ...
            {success ? (
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <button
                      type="submit"
                      disabled={loading}
                      className="mt-6 w-full sm:w-auto bg-(--primary) text-(--foreground) font-black uppercase py-4 px-10 tracking-[0.2em] hover:bg-white transition-all duration-300 rounded-sm disabled:opacity-60 disabled:cursor-not-allowed flex items-center gap-3"
                  >
                    {loading ? (
                        <>
