...
export const metadata: Metadata = {
  ...
  description: "Stolovi, police i namještaj od drveta i metala — rađen rukom, za generacije.",
};
      ...
      <SessionProvider session={session}>
        ...
        {children}
          ...
          <Toaster
              ...
              toastOptions={{
                  classNames: {
                      toast: "bg-white shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-gray-100 rounded-xl px-5 py-4",
