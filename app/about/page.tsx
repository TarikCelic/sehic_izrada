      ...
      <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
        <div className="flex-1 flex flex-col items-start gap-8 animate-fade-left">
          ...
          <div className="text-white/90 text-left max-w-xl text-lg md:text-xl leading-relaxed font-light">
            <p className="mb-6">
              <span className="font-bold text-white border-b border-(--primary)">
                Senaid Šehić
              </span>{" "}
              je osnivač brenda{" "}
              <span className="text-(--primary)">Sehić Izrada</span>, nastalog
              iz jednostavne ideje koja je kroz šest godina prerasla u ozbiljan
              i posvećen zanat.
            </p>
            <p className="mb-6">
              Sve je počelo izradom prvog drvenog stola, a danas iza njega stoji
              niz unikatnih komada namještaja oblikovanih kroz iskustvo i
              kontinuirano usavršavanje.
            </p>
            <p>
              Fokus njegovog rada je na ručnoj izradi, kvalitetu i pažljivo
              osmišljenom dizajnu. Svakom projektu pristupa s posebnom pažnjom,
              stvarajući namještaj koji ima{" "}
              <span className="italic">karakter i trajnost</span>.
            </p>
          </div>
        </div>
