            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:gap-16 items-start">
                    ...
                    <div className="flex flex-col gap-6 animate-fade-right">
                        ...
                        <div>
                            <p className="text-[11px] text-white/40 uppercase tracking-[0.18em] mb-3">Opis proizvoda</p>
                        ...
                        <div>
                            <p className="text-[11px] text-white/40 uppercase tracking-[0.18em] mb-2">Vrsta drveta</p>
                            <p className="text-gray-300 leading-relaxed text-sm sm:text-base break-words whitespace-pre-wrap lowercase first-letter:uppercase">{product.woodType}</p>
                        </div>

                        {(hasWhite || hasBlack || hasWooden) && (
                            <div>
                                <p className="text-[11px] text-white/40 uppercase tracking-[0.18em] mb-3">Dostupne boje</p>
                        ...
                        {product.dimensions && (
                            <div>
                                <p className="text-[11px] text-white/40 uppercase tracking-[0.18em] mb-2">Dimenzije</p>
                                <p className="text-gray-300 leading-relaxed text-sm sm:text-base break-words whitespace-pre-wrap flex justify-between mb:flex-col">
                                    {product.dimensions} <span className="text-white/40 leading-relaxed sm:text-base break-words whitespace-pre-wrap">  Dimenzije se mogu prilagoditi zelji kupaca!</span>
                                </p>
